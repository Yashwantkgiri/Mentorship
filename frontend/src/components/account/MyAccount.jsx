...
const MyAccount = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("http://localhost:5000/api/mentees/profile", profileData);
      Swal.fire({
        text: "Your account details have been updated and saved to the database!",
      ...
      Swal.fire({
        text: "Failed to save data to server",
        icon: "error",
        showCloseButton: true,
      });
      console.error(err);
